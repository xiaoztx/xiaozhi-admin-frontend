<template>
  <div class="edit-strategy-page">
    <div class="main-card">
      <div class="card-header">
        <div class="header-left">
          <span class="text-large font-600">编辑存储策略 - {{ form.name }}</span>
        </div>
      ...
      <div class="card-content">
        <h2 class="section-header-title">基本信息</h2>
        <el-form
          ref="formRef"
          :model="form"
          :rules="rules"
        ...
        >
          ...
          <template v-if="form.type === 'tencent'">
            ...
            <!-- 所属地域放到这里，参考图中好像没有直接显示，但为了完整性还是保留，或者按需调整顺序 -->
            ...
            <div class="mt-8">
               ...
               <el-form-item label="下线中转">
                 ...
                 <span class="inline-tip">开启后，用户下载文件时会通过 Anhcyu 代理，可以提供更好的访问控制和统计。</span>
               </el-form-item>
                 ...
                 <div class="acl-cards">
                   ...
                   >
                     <div class="acl-header">
                       <el-radio v-model="form.config.acl" label="public-read" class="acl-radio">公有读，私有写</el-radio>
                     </div>
                     <div class="acl-desc">
                   ...
                   >
                     <div class="acl-header">
                       <el-radio v-model="form.config.acl" label="private" class="acl-radio">私有读写</el-radio>
                     </div>
                     <div class="acl-desc">
...
onMounted(async () => {
  ...
  if (id) {
    ...
    try {
      // 从后端获取完整详情
      const res: any = await getStorageStrategy(Number(id))
